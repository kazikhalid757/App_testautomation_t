...
//        startAppiumService(portNumber);
        ...
        cap.setCapability("deviceName", "kazitamim");
//        cap.setCapability("udid", "emulator-5554");
        cap.setCapability("deviceVersion", "10");
        cap.setCapability("platformName", "Android");

        cap.setCapability("appPackage", "com.aljazeera.mobile");
        cap.setCapability("appActivity", "com.aljazeera.mobile.MainActivity");
